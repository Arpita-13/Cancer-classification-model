...
def train_models(data):
    ...
    for name, model_info in models.items():
        ...
        # Save the model
        joblib.dump(model_info, f"C:/Users/arpit/Desktop/BITS_PILANI/SEM 2/MACHINE LEARNING/assignment-2/model/{name.lower().replace(' ', '_')}.pkl")
        print(f" {name} saved")
    
    # Save scaler
    joblib.dump(data['scaler'], "C:/Users/arpit/Desktop/BITS_PILANI/SEM 2/MACHINE LEARNING/assignment-2/model/scaler.pkl")
    
    # Create results dataframe
    results_df = pd.DataFrame(results)
    
    # Save results to CSV
    results_df.to_csv("C:/Users/arpit/Desktop/BITS_PILANI/SEM 2/MACHINE LEARNING/assignment-2/model/model_evaluation_results.csv", index=False)
